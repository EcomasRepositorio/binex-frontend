...
import Logo from "@assets/img/logo/logo_head.png";
                        ...
                        <div className="col-xxl-6 col-xl-8">
                           <div className="tp-header-top-info">
                              <ul>
                                 ...
                                 <li>
                                    <a href="https://site2.q10.com/login?ReturnUrl=%2F&aplentId=0959465f-37c3-4032-803b-bbfc499af7a3" target='_blank'><span>
                                       <i className="fa-solid fa-envelope"></i></span>Aula virtual
                                    </a>
                                 </li>
                        ...
                        <div className="col-xxl-6 col-xl-4">
                           <div className="tp-header-top-right d-flex justify-content-end align-items-center">
                              <div className="header-call">
                                 <a href="https://api.whatsapp.com/send?phone=51921814045"target='_blank'><i className="fa-solid fa-phone"></i> +51 921 814 045</a>
                              </div>
                           ...
                           <div className="tp-header-main-right d-flex align-items-center justify-content-xl-end">
                              <div className="tp-header-search search-open-btn d-none d-xxl-block">
                                 ...
                                 <div className="tp-header-btn d-none d-xl-block pl-40">
                                    <Link className="tp-btn" href="/contact">LOGIN</Link>
                                 </div>
                              </div>
                           </div>
                        </div>
